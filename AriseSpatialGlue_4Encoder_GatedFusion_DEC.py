...
"""
================================================================================
  🧬 AriseSpatialGlue_4Encoder_GatedFusion_DEC.py
...
class DualGCNAll1Layer(nn.Module):
    ...
    def __init__(self, in_channels, hidden_channels, out_channels, q, dropout=0.0):
        ...
        # --- Spot-Adaptive Gated Fusion Layers ---
        self.fusion_layer1 = GatedAttentionFusion(dim=out_channels)
        self.fusion_layer_aux = GatedAttentionFusion(dim=out_channels)
    ...
    def forward(self, x_RNA, x_ADT,
        ...
        # 3. Arise Fusion (Spot-Adaptive Gated)
        fused_rna, _ = self.fusion_layer1(x_sim, x_dist)
        fused_aux, _ = self.fusion_layer_aux(aux_s, aux_d)
        fused_pro, _ = self.fusion_layer2(fused_rna, fused_aux)
