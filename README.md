...
5. [Codebase Registry](#-codebase-registry)
6. [Quickstart & CLI Commands](#-quickstart--cli-commands)
7. [Visual Analytics & Diagnostic Suite](#-visual-analytics--diagnostic-suite)
8. [Automatic Results Archiver](#-automatic-results-archiver)
...
| Capability | `Base` | `PlusV2` | `PlusV2_DEC` | `PlusV2_Motif_DEC` |
| :--- | :---: | :---: | :---: | :---: |
...
| **Kendall & Gal Uncertainty Balancing** | ❌ (Static) | ✅ (4 Tasks) | ✅ (5 Tasks) | ✅ (5 Tasks) |
| **Training Regime** | 1-Stage (350 ep) | 1-Stage (400 ep) | 2-Stage (250+150 ep) | 2-Stage (250+150 ep) |
| **Output Directory** | `results/` | `results_arise_plus_v2/` | `results_arise_plus_v2_dec/` | `results_arise_plus_v2_motif_dec/` |
...
### 4. Run Grand Champion Pipeline (Motifs + Losses + DEC)
```bash
