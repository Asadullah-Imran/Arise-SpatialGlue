...
def run_experiment(
    ...
    output_dir: str = "results_arise_plus_v2_motif_dec"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--output_dir',
        type=str,
        default="results_arise_plus_v2_motif_dec",
        help="Output directory for CSVs and plots (default: results_arise_plus_v2_motif_dec)"
    )
    parser.add_argument(
        '--device',
        type=str,
