...
# - Fusion: CAGE-style Fusion (Gated Intra-omic + QKV Local Inter-omic)
...
class DualGCNAll1Layer(nn.Module):
    ...
    def __init__(self, in_channels, hidden_channels, out_channels, q, dropout=0.0):
        ...
        # --- CAGE Fusion Layers ---
        self.atten_rna = GatedFusionLayer(out_channels)
        self.atten_aux = GatedFusionLayer(out_channels)
        self.atten_cross = QKVCrossFusionLayer(out_channels, attention_type='local')
...
def plot_all_visualizations(
    ...
    rna_pca_comps=60,
    true_labels=None,
    output_dir="results_spatial_arise_cage",
    show=False
):
    """
...
def run_experiment(
    ...
    output_dir: str = "results_spatial_arise_cage",
    data_dir: str = "data"
):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='results_spatial_arise_cage', help="Directory to save CSV results and plots")
